...
const Color darkBg = Color(0xFF0A0A0F);
const Color surfaceDark = Color(0xFF13131F);
...
Risk management ensures sustainability in investing and protects your portfolio against unpredictable market changes.
"""
    },
    {
...
"""
  ...
  void _unlockNext(int index) {
    if (index + 1 < unlockedLessons.length) {
      setState(() => unlockedLessons[index + 1] = true);
    }
  }
  ...
  Widget build(BuildContext context) {
    int unlocked = unlockedLessons.where((e) => e).length;
    double progress = unlocked / lessons.length;
            ...
            child: Column(
              children: [
                Row(
                  ...
                  children: [
                    Text(
                      "$unlocked of ${lessons.length} modules unlocked",
                      style: TextStyle(
  ...
  Widget _buildLessonCard(int index, bool isUnlocked) {
    ...
    final Color accent =
        isUnlocked ? (lesson['color'] as Color) : Colors.white24;
            ...
            child: Column(
              ...
              children: [
                Row(
                  ...
                  children: [
                    Container(
                      ...
                      child: Icon(lesson['icon'] as IconData,
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        shape: BoxShape.circle,
                        color: isUnlocked
                            ? greenMain.withOpacity(0.15)
                            : Colors.white.withOpacity(0.05),
                      ),
                      child: Icon(
                        isUnlocked ? Icons.lock_open_rounded : Icons.lock_rounded,
                        size: 13,
                        color: isUnlocked ? greenMain : Colors.white24,
                      ),
                    ),
                  ],
                ),
                ...
                Container(
                  ...
                  child: Text(
                    isUnlocked ? "Start Reading" : "Locked",
                    style: TextStyle(
                        color: accent,
                        fontSize: 10,
...
class _ArticleReaderPageState extends State<ArticleReaderPage> {
  ...
  Widget build(BuildContext context) {
    final Color accent =
        widget.lesson['color'] as Color? ?? purpleAccent;
    ...
    return AnimatedContainer(
      ...
      child: GestureDetector(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            color: canFinish ? greenMain : Colors.white.withOpacity(0.05),
            ...
            boxShadow: canFinish
                ? [
                    BoxShadow(
                        color: greenMain.withOpacity(0.3),
                        blurRadius: 20,
            ...
            child: Row(
              ...
              children: [
                Icon(
                  ...
                  color: canFinish ? Colors.black : Colors.white24,
                  size: 18,
                ),
                const SizedBox(width: 8),
                Text(
                  canFinish ? "Mark as Complete" : "Scroll to finish",
                  style: TextStyle(
                    color: canFinish ? Colors.black : Colors.white24,
                    fontWeight: FontWeight.w800,
                    fontSize: 14,
