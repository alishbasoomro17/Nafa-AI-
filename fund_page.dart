...
class _FundViewPageState extends State<FundViewPage> {
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                children: [
                  ...
                  // Row 2: Core Actions (Redesigned) - NOW INCLUDES "TIME TO INVEST"
          ...
          // Row 4: Primary CTA (Fixed Height at the bottom) - "Invest Now" is now the only button
          _buildCTAFooter(),
        ],
      ),
    );
  ...
  PreferredSizeWidget _buildAppBar() {
    return AppBar(
      ...
      actions: [
        // Keeping "Skip" for navigation consistency
        TextButton(
  ...
  Widget _buildActionButtonsRow() {
    return Row(
      ...
      children: [
        ...
        // *** CHANGE 2: Renamed from 'Details' to 'Time To Invest' ***
        _iconActionButton(
          title: "Time To Invest",
          icon: Icons.access_time_filled_rounded, // Better icon for timing
          color: Colors.lightGreenAccent,
          onTap: _showTimingDialog, // *** CHANGE 3: Shows the timing dialog ***
        ),
      ],
    );
  }

  // *** NEW METHOD for Timing Dialog (Moved logic from footer button) ***
  void _showTimingDialog() {
    showDialog(
      ...
      builder: (_) => AlertDialog(
        ...
        title: const Text("Investment Timing Alert",
            style: TextStyle(
                color: Colors.white, fontWeight: FontWeight.bold)),
        content: const Text(
            "Market conditions indicate this is GOOD TIME to invest.\n\nExpected yield increasing over next 3 months. BUY NOW!",
      ...
      child: Column(
        children: [
          ...
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              const Text("Estimated Final Value:",
  ...
  Widget _buildCTAFooter() {
    return Container(
      ...
      // *** CHANGE 1: Removed _buildGoodTimeButton() ***
      child: Column(
        children: [
